						...
						>
							<form id="form-pdf" class="d-none" action="<?= site_url('dashboard/export_pdf') ?>" method="POST" target="_blank">
								...
								<input
									...
									value="<?= $marketing[0]->id_user ?? $marketing ?>"
								>
								<input
									type="hidden"
									name="cabang_laporan"
							...
							<table class="display table table-bordered"> 
								<thead>
									<tr style="border-bottom: 0px solid black;">
										<th colspan="13" style="border-bottom: 0px solid black;">
											<div class="row">
									...
									<tr style="border-top:0px solid black;border-bottom: 0px solid black">
										<th colspan="13" style="border-top: 0px solid black;border-bottom: 0px solid black"></th>
									</tr>
