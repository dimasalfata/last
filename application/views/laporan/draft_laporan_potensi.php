							...
							<table class="display table table-bordered"> 
								<thead>
									<tr style="border-bottom: 0px solid black;">
										<th colspan="18" style="border-bottom: 0px solid black;">
											<div class="row">
									...
									<tr style="border-top:0px solid black;">
										<th colspan="18" style="border-top: 0px solid black;"></th>
									</tr>
									...
									<?php if (count($laporan) > 0): ?>
										<?php $no=1; foreach ($laporan as $key): ?>
											<tr>
												...
												<td><?php echo $key->usaha_nasabah;  ?></td>
												...
												<td><?php echo $key->status_nasabah != 'Nasabah Baru' ? 'Nasabah Baru' : $key->status_nasabah ; ?></td>
												<td>-</td>
												<td>
												...
												<td>[<?php echo $key->id_cabang;?>] <?php echo $key->nama_cabang;?></td>
											...
											<?php
												...
												foreach($laporan_fu as $fukey => $fus) {
													if($fus->id_nasabah == $key->id_nasabah) {
											...
											<?php foreach($laporan_fu as $fukey => $fus) : ?>
												...
												<?php if($fus->id_nasabah == $key->id_nasabah) : ?>
...
if($isLast) {
	if(in_array($key->status_nasabah, ['Realisasi', 'Tolak'])) {
		$status = $key->status_nasabah;
		$tgl = $key->tgl_realisasi ?? $fus->tanggal_fu;
									...
									<?php else : ?>
										<tr>
											<td colspan ="18" class="text-center text-danger"><h4>Data Tidak Ditemukan</h4></td>
										</tr>
									<?php endif ?>
