							...
							<table class="display table table-bordered"> 
								<thead>
									<tr style="border-bottom: 0px solid black;">
										<th colspan="17" style="border-bottom: 0px solid black;">
											<div class="row">
									...
									<tr style="border-top:0px solid black;">
										<th colspan="17" style="border-top: 0px solid black;"></th>
									</tr>
								...
								<tbody id="show_data" style="font-size: 10px;"> 
									...
									<?php else : ?>
										<tr>
											<td colspan ="17" class="text-center text-danger"><h4>Data Tidak Ditemukan</h4></td>
										</tr>
									<?php endif ?>
								</tbody>
							</table>
